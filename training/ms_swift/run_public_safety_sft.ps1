# Safety SFT: crisis and self-harm response repair
# Run after public Phase 0 if you want the adapter to learn safer crisis replies.
# Replace $previous_adapter with the latest public_phase0_sft checkpoint before running.
...
$previous_adapter = "D:\psychologicalAgent\training\ms_swift\outputs\public_phase0_sft\checkpoint-last"

swift sft `
  --model "Qwen/Qwen3-4B-Instruct-2507" `
  --dataset "D:\psychologicalAgent\data\training\public_sft\public_safety_train_ms_swift.jsonl" `
  --train_type lora `
  ...
  --save_steps 50 `
  --save_total_limit 2 `
  --output_dir "D:\psychologicalAgent\training\ms_swift\outputs\public_safety_sft"
