# Phase 0: public dialogue + psychological support SFT
# Use this after running: python scripts\build_public_sft_dataset.py
...
swift sft `
  ...
  --dataset "D:\psychologicalAgent\data\training\public_sft\public_phase0_chat_train_ms_swift.jsonl" `
  --train_type lora `
  --torch_dtype float16 `
  --quant_method bnb `
  --quant_bits 4 `
  ...
  --save_steps 100 `
  --save_total_limit 2 `
  --output_dir "D:\psychologicalAgent\training\ms_swift\outputs\public_phase0_sft"
