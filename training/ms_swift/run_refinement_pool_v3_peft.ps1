...
$dataset = Join-Path $projectRoot "data\training\feedback_bad_cases\refinement_pool_v3_20260511_ms_swift.jsonl"
$outDir = Join-Path $projectRoot "training\ms_swift\outputs\refinement_pool_v3_peft\v0-$timestamp"
...
Write-Host "Training conservative refinement PEFT patch..."
