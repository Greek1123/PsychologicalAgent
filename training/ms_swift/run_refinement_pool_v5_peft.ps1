...
$baseAdapter = Join-Path $projectRoot "training\ms_swift\outputs\refinement_pool_v4_peft\v0-20260520-215024\checkpoint-final"
$dataset = Join-Path $projectRoot "data\training\feedback_bad_cases\refinement_pool_v5_20260520_ms_swift.jsonl"
$outDir = Join-Path $projectRoot "training\ms_swift\outputs\refinement_pool_v5_peft\v0-$timestamp"
...
Write-Host "Training scenario-specific refinement PEFT patch..."
