# Curated behavior SFT: role boundary, privacy wording, weak-input handling.
# Run after: python scripts\build_curated_behavior_dataset.py
...
swift sft `
  --model "D:\llm_cache\modelscope\models\Qwen\Qwen3-4B-Instruct-2507" `
  --dataset "D:\psychologicalAgent\data\training\curated_behavior\curated_behavior_train_ms_swift.jsonl" `
  --train_type lora `
  ...
  --save_steps 100 `
  --save_total_limit 2 `
  --output_dir "D:\psychologicalAgent\training\ms_swift\outputs\curated_behavior_sft"
