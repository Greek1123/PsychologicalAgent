...
def _apply_priority_scenario_reply(
    ...
    if _is_support_disappointment_text(clean_user, history_text) and _has_weak_action_reply(clean_reply):
...
def _decision_boundary_reply() -> str:
    return (
        ...
        "\u5982\u679c\u4e09\u4e2a\u7b54\u6848\u90fd\u6307\u5411\u957f\u671f\u6d88\u8017\uff0c\u90a3\u81f3\u5c11\u8bf4\u660e\u9700\u8981\u4e25\u8083\u5904\u7406\uff1b\u6700\u7ec8\u51b3\u5b9a\u4ecd\u7136\u7531\u4f60\u505a\uff0c\u6211\u505a\u7684\u662f\u5e2e\u4f60\u4e0d\u5728\u60c5\u7eea\u6700\u9ad8\u70b9\u88ab\u8feb\u4e0b\u7ed3\u8bba\u3002"
    )
